...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class EdcManagementApiLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        private final EdcManagementApiPolicyLibraryAccessors laccForEdcManagementApiPolicyLibraryAccessors = new EdcManagementApiPolicyLibraryAccessors(owner);
        private final EdcManagementApiProtocolLibraryAccessors laccForEdcManagementApiProtocolLibraryAccessors = new EdcManagementApiProtocolLibraryAccessors(owner);
        ...
        private final EdcManagementApiTransferLibraryAccessors laccForEdcManagementApiTransferLibraryAccessors = new EdcManagementApiTransferLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>edc.management.api.policy</b>
         */
        public EdcManagementApiPolicyLibraryAccessors getPolicy() {
            return laccForEdcManagementApiPolicyLibraryAccessors;
        }

        /**
         * Group of libraries at <b>edc.management.api.protocol</b>
         */
        public EdcManagementApiProtocolLibraryAccessors getProtocol() {
            return laccForEdcManagementApiProtocolLibraryAccessors;
        }
        ...
        /**
         * Group of libraries at <b>edc.management.api.transfer</b>
         */
        public EdcManagementApiTransferLibraryAccessors getTransfer() {
            return laccForEdcManagementApiTransferLibraryAccessors;
        }
    ...
    public static class EdcManagementApiPolicyLibraryAccessors extends SubDependencyFactory {

        public EdcManagementApiPolicyLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>definition</b> with <b>org.eclipse.edc:policy-definition-api</b> coordinates and
         * with version reference <b>edc</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getDefinition() {
            return create("edc.management.api.policy.definition");
        }

    }

    public static class EdcManagementApiProtocolLibraryAccessors extends SubDependencyFactory {

        public EdcManagementApiProtocolLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>version</b> with <b>org.eclipse.edc:protocol-version-api</b> coordinates and
         * with version reference <b>edc</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getVersion() {
            return create("edc.management.api.protocol.version");
        }
    ...
    public static class EdcManagementApiTransferLibraryAccessors extends SubDependencyFactory {

        public EdcManagementApiTransferLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>process</b> with <b>org.eclipse.edc:transfer-process-api</b> coordinates and
         * with version reference <b>edc</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getProcess() {
            return create("edc.management.api.transfer.process");
        }
