...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class EdcManagementLibraryAccessors extends SubDependencyFactory {
        ...
        private final EdcManagementContractLibraryAccessors laccForEdcManagementContractLibraryAccessors = new EdcManagementContractLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>edc.management.contract</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public EdcManagementContractLibraryAccessors getContract() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForEdcManagementContractLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class EdcManagementContractLibraryAccessors extends SubDependencyFactory {
        private final EdcManagementContractAgreementLibraryAccessors laccForEdcManagementContractAgreementLibraryAccessors = new EdcManagementContractAgreementLibraryAccessors(owner);

        public EdcManagementContractLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>edc.management.contract.agreement</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public EdcManagementContractAgreementLibraryAccessors getAgreement() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForEdcManagementContractAgreementLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class EdcManagementContractAgreementLibraryAccessors extends SubDependencyFactory {

        public EdcManagementContractAgreementLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>api</b> with <b>org.eclipse.edc:contract-agreement-api</b> coordinates and
         * with version reference <b>edc</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getApi() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("edc.management.contract.agreement.api");
        }
